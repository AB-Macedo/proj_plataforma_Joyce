...
export default function BookingFlow() {
  ...
  const stepTitle = step === 1 ? '1 · ESCOLHA O TEMPO E A LEITURA' : step === 2 ? '2 · ESCOLHA COMO PREFERE RECEBER' : '3 · ESCOLHA A DATA E O HORÁRIO';
  ...
  return (
    <form className="calendar-card booking-flow" onSubmit={submit}>
      ...
      {step === 3 && <div className="booking-section flow-stage">
