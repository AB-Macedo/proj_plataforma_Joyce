...
type Data = { services: Service[]; availability: Availability[]; exceptions: Exception[]; customers: Customer[]; appointments: Appointment[]; templates: Template[] };
