...
export const metadata: Metadata = { title: 'Privacidade e uso de dados | Magia Theia' };

export default function PrivacyPage() {
  return <main className="privacy-page">
    <header className="privacy-header"><a className="brand" href="/"><span className="brand-mark">M</span><span>Magia Theia</span></a><a href="/" className="text-link">← Voltar ao início</a></header>
