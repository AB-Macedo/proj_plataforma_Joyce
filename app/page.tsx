...
export default function Home() {
  return (
    <main>
      ...
      <section className="feedback-section section" id="feedback"><div><p className="kicker"><span /> Feedback privado</p><h2>Sua opinião ajuda a cuidar melhor de cada atendimento.</h2><p>Se você já passou por uma leitura, conte como foi. A mensagem vai apenas para Joyce Magia e não será publicada.</p></div><FeedbackForm /></section>
